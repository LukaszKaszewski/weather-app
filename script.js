const WeatherApp = class {
    ...
    drawWeather(cityQuery) {
        ...
        headerCurrent.innerHTML = 'Obecna pogoda dla miasta ' + cityQuery;
        ...
        headerForecast.innerHTML = 'Pogoda prognozowana dla miasta ' + cityQuery;
    ...
    createWeatherBlock(dateString, temperature, feelsLikeTemperature, iconName, description) {
        ...
        temperatureFeelBlock.innerHTML = `Temp. odczuwalna: ${Math.round(feelsLikeTemperature * 10) / 10} &deg;C`;
